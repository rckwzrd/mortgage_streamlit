# TODO:
# convert to single page with side bar, persistent is not working yet --> done
# make environment and requirements.txt, git ignore .env --> done
# implement comparison, need current mortgage --> done

# refractor functions to helpers.py
# annotate main page with markdown
# implement check boxes
# implement downpayment, interest plots, and long term modeling
# deploy to server 
...
def compare_output(data:dict):
    st.subheader(f"Compare current and estimated mortgage:")
